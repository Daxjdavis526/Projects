...
**BRANCH** — a music-driven generative lightning and vascular growth system.
Thin luminous structures grow across black in real time; the physics is driven
by live analysis of whatever is playing.

Live: https://daxjdavis526.github.io/Projects/branch/
...
null geodesics through curved spacetime on the GPU. Gravitational lensing,
the photon ring, the doubly-imaged accretion disk and Doppler beaming all
emerge from the physics. Free-flight camera, orbit and free-fall modes,
mass/spin presets, educational overlays and a guided tour. Desktop only.

Live: https://daxjdavis526.github.io/Projects/blackhole/

See [blackhole/README.md](blackhole/README.md) for controls and the physics
model.
...
of fourteen biomes, three kinds of caves, seven ores, water that flows, day and
night, weather, and eight original creatures with their own AI; tools in five
tiers, armour, a hunting bow, crafting, cooking, smelting, farming, crates,
building, lumen circuits that work lamps and doors, death and respawn, and
worlds that save and load, with a soundtrack of seven original pieces for a
synthesised piano. Every texture, model, sound and note of music is generated
by the game's own code.

Unlike everything else here, this one is a **desktop game** — a Godot 4 project
in C# — so there is no live link. Open `strata/project.godot` in Godot 4.7
(.NET edition), or export a standalone build for Windows or Linux with the
included presets. 636 headless checks plus a scripted play-through that plays
the whole survival loop, from the first tree to saving and reloading.
