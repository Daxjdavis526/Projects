...
Output: propulsion/offline/CRYOGENICS-course.html (~15 MB). Double-click it
...
<title>CRYOGENICS — course (offline)</title>
<style>{css}</style>
<script>
...
"""
    ...
    out = os.path.join(out_dir, "CRYOGENICS-course.html")
