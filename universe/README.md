...
| `T` | guided tour — a 13-stop cinematic ride from home to the horizon |
| `0` / `Home` | return to Earth |
| `M` | ambient sound on/off |
| `Esc` | close panels / end tour |
...
- **Named stars**: 57 real stars at real RA/dec/distances, colors and
  luminosities from spectral class.
