...
| **LROC Lunar Pits Atlas** | LROC pit catalogue via `data/sites.json` | published centre and depth per pit | **vendored** as two site records | the two lava-tube skylights are findable and reachable: Marius Hills at 14.0917 N, 56.7701 W, 40 m deep, and Mare Tranquillitatis at 8.3355 N, 33.222 E, 105 m deep | the coordinates are measured; the **holes are not drawn**. They are 55 and 100 m across and the finest elevation over either is 118 m/px, so nothing flown has resolved them in topography and modelling them would mean inventing the shape of the one thing you went to see |
