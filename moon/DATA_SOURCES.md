...
| **Diviner bolometric temperature** (Williams et al. 2017) | Trek `diviner_tbol_max`, `_min`, `_hour12`, `_hour00` | 0.5° ≈ 15 km | **streamed** | surface temperature by location and local time (Tranquility: 395.6 K max, 95.2 K min) | REGIONAL / DERIVED |
